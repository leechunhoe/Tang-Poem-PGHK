...
class PoemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poem" do
    assert_difference('Poem.count') do
      post poems_url, params: { poem: { hanji: @poem.hanji, hongim: @poem.hongim, stailo: @poem.stailo } }
    end
  ...
  test "should update poem" do
    patch poem_url(@poem), params: { poem: { hanji: @poem.hanji, hongim: @poem.hongim, stailo: @poem.stailo } }
